...
namespace DesignPatternsLibrary.Disposable
{
    public class AutoDisposeStack : IEnumerable, IDisposable
    {
        ...
        public AutoDisposeStack(bool allowNullObjects, bool throwItemDisposeException)
        {
            _allowNullObjects = allowNullObjects;
            _throwItemDisposeException = throwItemDisposeException;
        }
